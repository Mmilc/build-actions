...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='10.0.0.29'                                    # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                                 # IPv4 子网掩码
uci set network.lan.gateway='10.0.0.30'                                   # IPv4 网关
...
uci set system.@system[0].hostname='OpenWrt-ROS'                            # 修改主机名称为OpenWrt-123
